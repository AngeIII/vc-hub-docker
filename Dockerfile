...
RUN apt-get install -y --force-yes php5.6-fpm php5.6-common php5.6-cli php-pear php5.6-curl php5.6-gd php5.6-mbstring php5.6-mcrypt php5.6-xml php5.6-mysql php5.6-readline \
